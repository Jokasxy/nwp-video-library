...
<div class="container genres">
    <div class="col-md-10" style="margin-left:10px;display: flex; justify-content: flex-end">
        @can('modify')
        <a class="btn btn-small btn-primary btn-add" style="margin-bottom: 10px;" href="{{ url('/genres/create') }}">{{ __('form.genre_create') }}</a>
        @endcan
    </div>
            ...
            <div class="card">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td style="text-align:center"><b>{{ __('form.genre_empty') }}</b></td>
                            @can('modify')
